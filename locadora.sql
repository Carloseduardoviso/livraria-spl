...
create table cliente (
 ...
 alter table locacao
 add constraint fk_auto_cod foreign key (auto_cod) references automovel;
 
 alter table locacao
 add constraint fk_cliente_cod foreign key (cliente_cod) references cliente;
 
 alter table automovel
 add constraint fk_marca_cod foreign key (marca_cod) references marca;
 
 alter table automovel
 add constraint fk_modelo_cod foreign key (modelo_cod) references modelo;
